...
class Recipe(models.Model):
    ...
    category = models.ForeignKey(RecipeCategory, on_delete=models.CASCADE, verbose_name='فئة الوصفة')
    recipe_source = models.CharField(max_length=255, null=True, blank=True, verbose_name='مصدر الوصفة')
    ...
    date_created = models.DateTimeField(default=timezone.now, verbose_name='تاريخ الإضافة')
    image = models.ImageField(null=True, blank=True,
...
class Comment(models.Model):
    ...
    comment_date = models.DateTimeField(default=timezone.now, verbose_name='تاريخ التعليق')
    active = models.BooleanField(default=False)
    recipe = models.ForeignKey(Recipe, on_delete=models.CASCADE, related_name='comments', verbose_name='التعليقات')
...
class RecipeIngredient(models.Model):
    recipe = models.ForeignKey(Recipe, on_delete=models.CASCADE, verbose_name='الوصفة')
