...
!function (t, e) {
    ...
    var s = {
        ...
        c = "datepicker", n = "click.".concat(c), r = "focus.".concat(c), h = "hide.".concat(c), o = "keyup.".concat(c),
        l = "pick.".concat(c), d = "resize.".concat(c), u = "scroll.".concat(c), p = "show.".concat(c),
    ...
    function I(t, e) {
        var i = 1 < arguments.length && void 0 !== e ? e : 1, a = String(Math.abs(t)), s = a.length, n = "";
    ...
    var S = /\d+/g, P = {
            ...
            render: function () {
                ...
                for (r && (P = N.getTime() >= r.getTime()), e = 1; e <= i; e += 1) {
                    var j = new Date(I, S, e), q = I === k && S === D && e === b, A = !1;
        ...
        W = "".concat(c, "-bottom-right"), z = [q, A, O, W].join(" "), J = function () {
            function i(t) {
                ...
                !function (t, e) {
                    ...
                    var i = 1 < arguments.length && void 0 !== e && e, a = D(t), s = a.css("position"),
                        n = "absolute" === s, r = i ? /auto|scroll|hidden/ : /auto|scroll/,
            ...
            return function (t, e, i) {
                ...
                key: "init", value: function () {
                    ...
                    this.$trigger = D(e.trigger), this.isInput = t.is("input") || t.is("textarea"), this.inline = e.inline && (e.container || !this.isInput), this.format = function (i) {
                        var t = String(i).toLowerCase(), e = t.match(T);
                ...
                key: "setValue", value: function (t) {
                    var e = 0 < arguments.length && void 0 !== t ? t : "", i = this.$element;
